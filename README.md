...
local Window = Rayfield:CreateWindow({
    ...
    LoadingSubtitle = "O MELHOR DA ATUALIDADE🥇",
    ConfigurationSaving = {
        Enabled = true,
...
local Tab = Window:CreateTab("Aim-PC") -- Icon ID (optional)
...
local function checkStaffTeam()
    ...
    for _, player in ipairs(Players:GetPlayers()) do
        if player.Team and player.Team.Name == teamName then
            localPlayer:Kick("Você foi kickado pelo anti STAFF do Fantasma011")
            return
        end
    end
end
...
local Paragraph = VisualTab:CreateParagraph({Title = "Menu Gold", Content = "feito por Fantasma011"})
...
local Paragraph = TeleportTab:CreateParagraph({Title = "Menu Gold", Content = "feito por Fantasma011"})
...
addTeleportButton("Teleport Pescaria", CFrame.new(-1293.48242, 8.52046108, -1205.9408, 0, 0, 1, 0, 1, -0, -1, 0, 0))
addTeleportButton("Teleport Lavagem de dinheiro", CFrame.new(19799.0469, 69.3573303, 13196.6631, -0.766061664, 0, -0.642767608, 0, 1, 0, 0.642767608, 0, -0.766061664))
addTeleportButton("Teleport Apartamentos", CFrame.new(-1737.96167, 0.27999568, 318.126923, -0.866007447, 0, -0.500031412, 0, 1, 0, 0.500031412, 0, -0.866007447))
...
local rev = Window:CreateTab("Auto Revistar")
local Paragraph = rev:CreateParagraph({Title = "Menu Gold", Content = "feito por Fantasma011"})
local Section = rev:CreateSection("OBRIGATORIO")
local Button = rev:CreateButton({
   Name = "Puxar itens do inv 1 click por vez",
   Callback = function()
...
local itens = {"AK47", "Uzi", "PARAFAL", "Faca", "IA2", "G3", "iPhone 14", "Agua", "Hamburguer", "Hi Power", "Natalina", "AR-15", "Tratamento", "Lockpick", "Escudo", "Glock 17", "HK416"}
...
RevistarButton.BackgroundColor3 = Color3.fromRGB(249, 233, 153)
RevistarButton.Text = "⚔️REVISTAR PLAYER⚔️"
...
local Paragraph = otoTab:CreateParagraph({Title = "Menu Gold", Content = "feito por Fantasma011"})
...
local Section = otoTab:CreateSection("AUTO QUIT GAME")
...
local Tab = Window:CreateTab("Fly") -- Icon ID (optional)

-- Adicionando o botão para executar o script
Tab:CreateButton({
    Name = "Executar Fly",
    Callback = function()
        -- Executa o script através do loadstring
        loadstring(game:HttpGet("https://raw.githubusercontent.com/pedrowaooee/Fly/refs/heads/main/Fly%20Menu%20gold"))()
    end,
})

local Tab = Window:CreateTab("Aim-Mobile") -- Icon ID (optional)
...
Tab:CreateButton({
    ...
    Callback = function()
        -- Executa o script através do loadstring
        loadstring(game:HttpGet("https://pastebin.com/raw/58JYvTCN"))()
    end,
})
